...
const OtpDialog = ({handleOTPSubmit, handleCloseOTPDialog, isOpen}: {
    ...
    return (
        <>
            <Dialog open={isOpen}>
                ...
                <DialogContent>
                    <p>We have sent OTP to your email. Please check and enter it below:</p>
                    <form>
                        <TextField
                            label="OTP"
                            value={otp}
                ...
                <DialogActions>
                    <Button onClick={() => handleOTPSubmit(otp)} color="primary" disabled={otpError}>
                        Submit
                    </Button>
